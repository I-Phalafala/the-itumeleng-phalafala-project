...
import { getExperienceById, updateExperience } from "@/lib/firebase/services/experience";
...
export default function EditExperiencePage() {
  ...
  async function handleSubmit(data: ExperienceFormValues) {
    ...
    try {
      ...
      if (result.success) {
        addToast("success", "Experience entry updated successfully.");
    ...
    <div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        {loadingExperience ? (
          ...
          <p className="text-sm text-gray-500">Experience entry not found.</p>
        ) : (
          <ExperienceForm
            key={experience.id}
